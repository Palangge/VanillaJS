...
/*
    SYNTAX:
    for (initialization; condition; increment) - these three are what we call params(parameters) inside the loop
    {
        //block of code
    }
    USAGES:
...
// //if the confition is < 5 it will display the output from 0 to 4
...
//BONUS
//continue statement - beraks one iteration (in the loop if a specify condition occurs)

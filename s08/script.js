...
// //Template Literals
// //allows to write strings without using  the concatinate operator (+)
...
// //it allows to unpack elements in array into distinct variables
...
// //solution
// console.log(`Hello ${fullName[1]} ${fullName[2]}, ${fullName[0]}! It's nice to meet you.`);
...
// //console.log(`His pets are: ${pet1}, ${pet2}, ${pet3}!`);
...
//     console.group(`My name is ${personObject.givenName}, ${personObject.maidenName}, ${personObject.familyName}.`);
// }
// getFullName(person);
...
// //adheres to DRY ("Don't Repeat Yourself") method
// /* syntax: 
...
// const Hello = () => console.log("Hellow World version 2!");
// Hello();
...
// const introduce_Student = (name) => {
//   console.log(`Hi! My name is ${name}.`);
// }

// introduce_Student(student1);
// introduce_Student(student2);
// introduce_Student(student3);

// //Solution A
// const greeting = () => {
//     console.log(`Hi! My name is ${student1}.`);
...
// //Step 1: Instantiate an object using "new" keyword + the class name
// const myCar = new Car();
// console.log(myCar); //it displays undefined because we did not assign any values on it

// //using an assignment operator it assign to properties after instantiation of an object
// myCar.brand = "Ford";
// myCar.name = "Ranger Raptor";
// myCar.year = 2021;
// console.log(myCar); //it displays the defined properties in the class objects.
...
// //function - represents actions that object can take
// //a.k.a "methods"